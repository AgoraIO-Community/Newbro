...
- [Interaction Request and Attention](./protocol/interaction-request-and-attention.md)
...
- [Verification Strategy](./roadmap/verification-strategy.md)
- [Current Milestone](./roadmap/current-milestone.md)

## Decisions

- [Decisions Index](./decisions/index.md)
- [0001 Blackboard-Centered Runtime](./decisions/0001-blackboard-centered-runtime.md)
- [0002 No Message Interpreter](./decisions/0002-no-message-interpreter.md)
- [0003 Sessionized Execution](./decisions/0003-sessionized-execution.md)
- [0004 Proactive Notifications and Interruptions](./decisions/0004-proactive-notifications-and-interruptions.md)
...
- [0005 Newbro x acpx Execution Runtime Integration](./rfcs/0005-acpx-execution-runtime-integration.md)
