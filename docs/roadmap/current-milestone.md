...
- `newbro v0 Draft-to-Execute MVP`
- status: `in progress`
...
- production-grade draft rewriting quality
- pause/resume or redirect semantics for running tasks
- multi-Bro simultaneous drafting
